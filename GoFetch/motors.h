...
#define MOTOR_SPEED_LIMIT 1100 // [step/s]
 ...
 /**
 * @brief   Sets mode to ongoing, independently of steps to complete
 *
 * @param _ongoing 	boolean is_ongoing?
 */

void motors_set_ongoing(uint8_t _ongoing);

 /**
 * @brief   Sets steps to be completed by motor before it stops
 *
